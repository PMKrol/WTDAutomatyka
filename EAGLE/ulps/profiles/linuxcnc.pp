...
string RAPID_MOVE_XY_HOME = RAPID + "X-90 Y0";
...
string TOOL_CHANGE = "G90F1000Z20" + EOL
                       + "G90 X" + TOOL_CHANGE_POS_X + " Y" + TOOL_CHANGE_POS_Y + EOL
                       + OPERATOR_PAUSE + TOOL_CODE + " ; " + FORMAT + EOL
                       + "G90 F100 Z3; (Go fast 3mm over surface)" 
                       + "G90 G38.2 F10 Z-10" + EOL
                       + "G10 P0 L20 Z0" + EOL
                       + "G0 F1000 Z1" + EOL
                       ;
