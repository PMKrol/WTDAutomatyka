...
string FILENAME_BOT_ETCH_FILE = ".$SIDE.3.$FILE.$EXT";
string FILENAME_BOT_DRILL_FILE = ".$SIDE.1.$FILE.$EXT";
string FILENAME_BOT_MILL_FILE = ".$SIDE.2.$FILE.$EXT";
