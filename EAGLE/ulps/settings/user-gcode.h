...
MILL_BEGIN[ALL]    = "(MILL Begin)\n" +
                            ...
                            "M05" + EOL +
                            "G00 Z20.0000" + EOL + 
                            "G00 X-10.0000 Y10.0000" + EOL +
                            "M00 (MSG, Install probe)" + EOL + 
                            "G90 F100 Z2; (Go fast 2mm over surface)" + EOL + 
                            "G90 G38.2 F10 Z-10" + EOL +
                            "M00 (MSG, Remove probe. Z0 will be set after.)" + EOL +
                            "G10 P0 L20 Z0" + EOL + 
                            "S1000" +  EOL  +
                            "G00 Z1" + EOL +
                            "M03" + EOL +
